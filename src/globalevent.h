...
private:
	std::string getScriptBaseName() const { return "globalevents"; }
...
class GlobalEvent final : public ScriptEvent
{
public:
	explicit GlobalEvent(LuaScriptInterface* interface) : ScriptEvent(interface) {}
