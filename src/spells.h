...
class CombatSpell final : public ScriptEvent, public BaseSpell
{
public:
...
public:
	...
	void setCooldown(uint32_t a) { cooldown = a; }
	...
	bool getCooldownSpellTime() const { return cooldownSpellTime; }
	void setCooldownSpellTime(bool a) { this->cooldownSpellTime = a; }
...
public:
	...
	bool executeUse(Player* player, Item* item, const Position& fromPosition, Thing* target,
	                const Position& toPosition) override;
