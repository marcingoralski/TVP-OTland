...
private:
	...
	void clearPosMap(MovePosListMap& map);
...
class MoveEvent final : public ScriptEvent
{
public:
	explicit MoveEvent(LuaScriptInterface* interface) : ScriptEvent(interface) {}
