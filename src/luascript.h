...
private:
	...
	static int luaDoAddOfflinePlayerMoney(lua_State* L);
	...
	static int luaPlayerLoadDepotLocker(lua_State* L);
	static int luaPlayerUnloadDepotLocker(lua_State* L);
	...
	static int luaPlayerGetStringStorageValue(lua_State* L);
	static int luaPlayerSetStringStorageValue(lua_State* L);
	...
	static int luaPlayerGetMaxDepotItems(lua_State* L);
	...
	static int luaMonsterAddWaitToDo(lua_State* L);
	static int luaMonsterAddGoToDo(lua_State* L);
	static int luaMonsterAddAttackToDo(lua_State* L);
	static int luaMonsterCastAttackSpells(lua_State* L);
	static int luaMonsterCastDefensiveSpells(lua_State* L);
	static int luaMonsterSpawnSummons(lua_State* L);
	static int luaMonsterStartToDo(lua_State* L);
